      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            info="Completed a master's program focused on deep learning and also engaged in web development and data mining projects during the program."
           />

          <Details
            type="Bachelor of technology in Computer Science"
            time="2013-2017"
            place="Jawaharlal Nehru Technological University"
            info="Relevant courses included Data Structures and Algorithms, operating systems and software testing methodologies."
          />
        </ul>
      </div>
    </div>
